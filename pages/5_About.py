...
def main():
    ...
    try:
        ...
        with tabs[1].expander(
            ...
            sl.markdown(
                "<p><b>Abyssonym</b>, original creator of Beyond Chaos.<br>&emsp;"
                '<a href="https://github.com/abyssonym">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_github.png") + '>'
                '</a>&emsp;'
                '<a href="https://www.twitch.tv/abyssonym">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_twitch.png") + '>'
                '</a>&emsp;'
                '<a href="https://twitter.com/abyssonym">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_twitter.png") + '>'
                '</a>&emsp;'
                '<a href="https://discord.gg/Vzk2tsm92A">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_discord.png") + '>'
                '</a></p>'                        
                                                                
                "<p><b>SubtractionSoup</b>, second creator of Beyond Chaos.<br>&emsp;"
                '<a href="https://github.com/subtractionsoup">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_github.png") + '>'
                '</a></p>'
                                                                
                "<p><b>DarkSlash88</b>, current Beyond Chaos project leader.<br>&emsp;"
                ...
                "<p><b>fusoyeahhhh</b>, brain behind BC Fantasy, BC Flag Drafter, and FFVI Script Randomizer<br>&emsp;"
                ...
                "<p><b>Crimdahl</b>, Python coder and creator of this web interface<br>&emsp;"
                '<a href="https://github.com/Crimdahl">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_github.png") + '>'
                '</a></p>'
                                                                
                "<p><b>AnubianCDude</b>, romhacker and ASM wizard<br>&emsp;</p>"          
                                                                
                "<p><b>Cecil188</b>, creator of Cecilbot<br>&emsp;"
        ...
        with tabs[1].expander(
            ...
            sl.markdown(
                "<p><b>JennyBeans</b>, robot streamer extrordinaire<br>&emsp;"
                ...
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_youtube.png") + '>'
                '</a>&emsp;'
                ...
                "<p><b>Quikdraw7777</b><br>&emsp;"
                '<a href="https://www.twitch.tv/quikdraw7777">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_twitch.png") + '>'
                '</a></p>'
                                                                
                "<p><b>Cjrynnchere</b><br>&emsp;"
                '<a href="https://twitch.tv/cjrynnchere">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_twitch.png") + '>'
                '</a></p>'
                                                                
                "<p><b>EmpressFordola</b><br>&emsp;"
                ...
                "<p><b>muppetsinspace</b><br>&emsp;"
                '<a href="http://www.twitch.tv/muppetsinspace">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_twitch.png") + '>'
                '</a></p>'   
                                                                
                "<p><b>graffin226</b><br>&emsp;"
                ...
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_instagram.png") + '>'
                '</a>&emsp;'
                '<a href="https://www.tiktok.com/@zenithsagettv">'
                '<img style="background-color: white;" width="25" height="25"'
                'src=' + img_to_html("images/ico_tiktok.png") + '>'
                '</a></p>'
                ,
                unsafe_allow_html=True
            )
