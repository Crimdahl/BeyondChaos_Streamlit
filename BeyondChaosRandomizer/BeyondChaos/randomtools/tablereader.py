from BeyondChaosRandomizer.BeyondChaos.randomtools.psx_file_extractor import FileManager, SANDBOX_PATH
from BeyondChaosRandomizer.BeyondChaos.randomtools.utils import (read_multi, write_multi, classproperty,
...
def write_cmp_patch(outfile, patchfilename, verify=False):
    from BeyondChaosRandomizer.BeyondChaos.randomtools.interface import get_sourcefile
...
def verify_patches(outfile, strict=False):
    ...
    from BeyondChaosRandomizer.BeyondChaos.randomizer import pipe_print
    pipe_print("Verifying patches...")
    if strict:
