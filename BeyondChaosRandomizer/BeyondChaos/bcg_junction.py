from BeyondChaosRandomizer.BeyondChaos.randomtools.utils import map_to_snes
from BeyondChaosRandomizer.BeyondChaos.randomtools.tablereader import tblpath, write_patch, set_addressing_mode
